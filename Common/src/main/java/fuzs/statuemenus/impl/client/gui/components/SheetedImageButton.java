...
public class SheetedImageButton extends Button {
    ...
    public SheetedImageButton(int x, int y, int width, int height, int xTexStart, int yTexStart, Identifier identifier, OnPress onPress) {
        this(x, y, width, height, xTexStart, yTexStart, height, identifier, onPress);
    }

    public SheetedImageButton(int x, int y, int width, int height, int xTexStart, int yTexStart, int yDiffTex, Identifier identifier, OnPress onPress) {
        this(x, y, width, height, xTexStart, yTexStart, yDiffTex, identifier, 256, 256, onPress);
    }

    public SheetedImageButton(int x, int y, int width, int height, int xTexStart, int yTexStart, int yDiffTex, Identifier identifier, int textureWidth, int textureHeight, OnPress onPress) {
        this(x,
                y,
                width,
                height,
    ...
    public SheetedImageButton(int x, int y, int width, int height, int xTexStart, int yTexStart, int yDiffTex, Identifier identifier, int textureWidth, int textureHeight, OnPress onPress, Component message) {
    ...
    public SheetedImageButton setTextureCoordinates(int xTexStart, int yTexStart) {
        this.xTexStart = xTexStart;
        this.yTexStart = yTexStart;
        return this;
    }

    public SheetedImageButton setTextureDimensions(int textureWidth, int textureHeight) {
        this.textureWidth = textureWidth;
        this.textureHeight = textureHeight;
        return this;
    }
     ...
     */
    public SheetedImageButton setTextureLayout(ToIntFunction<Button> textureLayout) {
     ...
     * @return builder instance
     */
    public SheetedImageButton setDrawBackground() {
